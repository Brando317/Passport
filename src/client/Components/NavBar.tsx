...
import { NavLink, useLocation, useHistory } "react-router-dom";
...
<h1 className = "logo text-success"> Success!!! </h1>
...
<input type="text" className="form-control" placeholder="Search User" value={searchItem} onChange={(e: React.changeEvent<HTMLInputElement>) => setSearchItem(e.target.value)}
/>
<div className="input-group-append p-2 text-center">
