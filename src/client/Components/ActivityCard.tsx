...
<div className="avatarSmall text-light bg-success text-center mr-2"
onClick = { () => history.push (`/user_activities/${props.entry.userid}`) }
>
{ props.entryfirstname[0] }
</div>
...
<span> { averagePace (props.entry.hrs, props.entry.min, props.entry.sec, props.entry.distance) } </span>
</div>
</div>
</div>
);
